...
function Dashboard() {
    ...
    const fetchReports = async () => {
        ...
        try {
            ...
            const response = await axios.get("https://legal-tammi-student0617-c9760f79.koyeb.app/api/auth/reports", {
                headers: {
    ...
    const fetchPDF = async () => {
        const token = localStorage.getItem('token');
        try {
            const response = await axios.get("https://legal-tammi-student0617-c9760f79.koyeb.app/api/auth/reports/pdf", {
